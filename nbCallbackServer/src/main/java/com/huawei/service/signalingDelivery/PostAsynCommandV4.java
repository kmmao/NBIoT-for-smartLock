...
public class PostAsynCommandV4 {
    ...
    public static String postCommand(String deviceId, String cmd, Integer expireTime ) throws Exception{
        ...
        String serviceId = "PostCommandToDevice";
        String method = "Post_Command";
        ObjectNode paras = JsonUtil.convertObject2ObjectNode("{\"CommandStr\":\"" + cmd + "\"}");
