...
public class Constant {
    ...
    public static final String APPID = "S6_t82lfCxLftiPxufEqVz626LMa";
    public static final String SECRET = "KvIF5RxE8ZGS0QmjtZtE6JmkDoQa";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://61.183.225.85:8082/NBIoT/callback";
    ...
    public static final String SUBSCRIBES_NOTIFYCATION = BASE_URL + "/iocm/app/sub/v1.2.0/subscriptions";
