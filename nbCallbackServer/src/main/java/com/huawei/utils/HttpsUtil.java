...
public class HttpsUtil extends DefaultHttpClient {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		InputStream is1 = this.getClass().getResourceAsStream(Constant.SELFCERTPATH);
		InputStream is2 = this.getClass().getResourceAsStream(Constant.TRUSTCAPATH);
		...
		caCert.load(is2, Constant.TRUSTCAPWD.toCharArray());
