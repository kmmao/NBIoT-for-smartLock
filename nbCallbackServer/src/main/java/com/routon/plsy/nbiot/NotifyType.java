...
public class NotifyType {
    ...
    public static final String TEST_CALLBACK_BASE_URL = "http://61.183.225.85:8082/NBIoT/callback";

    public static List<String> notifyTypes = new ArrayList<String>();
