 ...
 */
public class PageCompanyDecorator extends TableDecorator
{
  /**
  ...
  public PageCompanyDecorator()
  {
	...
	//获取用户管理模块的id
	public String getId(){
		Company t = (Company) getCurrentRowObject();
		Long id = t.getId();
		return "<a onclick=\"editCompany(this)\" style=\"cursor:pointer;\"> " + id + " </a>";
	}
