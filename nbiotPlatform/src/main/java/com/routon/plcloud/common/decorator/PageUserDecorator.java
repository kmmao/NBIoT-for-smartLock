 ...
 */
public class PageUserDecorator extends TableDecorator
{
  /**
  ...
  public PageUserDecorator()
  {
	...
	//获取用户管理模块的id
	public String getId(){
		User t = (User) getCurrentRowObject();
		Long id = t.getId();
		return "<a onclick=\"editUser(this)\" style=\"cursor:pointer;\"> " + id + " </a>";
	}
