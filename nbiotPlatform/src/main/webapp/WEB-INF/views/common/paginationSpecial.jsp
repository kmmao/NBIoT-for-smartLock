			...
			<div class="btn-group">
				<div class="btn-group" style="margin-right: 6px;">
				  <ul class="pagination" style="margin-bottom: 0px;margin-top: 0px;">
					<c:choose> 
						<c:when test="${page > 1}">  
							<li><a href="javascript:void(0);" onclick="gotopage5(${page-1},${page},${maxpage})"  >&laquo;</a></li>
						</c:when>
						<c:otherwise>
							
							<li class="disabled" ><a href="javascript:void(0);" onclick="gotopage5(${page-1},${page},${maxpage})"  >&laquo;</a></li>
					...
					<c:choose> 
							...
							<c:forEach var="i" begin="${page}" end="${maxpage}">
								<c:choose> 
									<c:when test="${j == 6}">  
										...
										<li><a href="javascript:void(0);" onclick="gotopage5(${maxpage},${page},${maxpage})" >${maxpage}</a></li>
									</c:when>
									<c:when test="${j < 6}">  
										<c:choose> 
											<c:when test="${j==1}">  
											...
											<c:otherwise>
												<li><a href="javascript:void(0);" onclick="gotopage5(${i},${page},${maxpage})" >${i}</a></li>
											</c:otherwise>
										</c:choose>
						...
						<c:choose> 
							...
							<c:otherwise>
								<li><a href="javascript:void(0);" onclick="gotopage5(${page+1},${page},${maxpage})"  >&raquo;</a></li>
			   	...
			   	<div class="btn-group">
		  			...
		  			<div class="btn-group">
		  				<button type="button" class="btn btn-primary" onclick="gotopage5(null,${page},${maxpage})">确定</button>
		  			</div>
		  			<div class="btn-group">
